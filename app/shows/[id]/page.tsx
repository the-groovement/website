        ...
        <div className="flex flex-row justify-between mb-8 md:mb-12">
          <div className="flex flex-col flex-1 mr-16">
            ...
            <Link
              ...
              className="w-fit text-lg md:text-3xl mb-2 font-semibold hover:text-grooveHover underline"
            >
            ...
            {currentEvent.venue.googlemaps ? (
              <a
                ...
                target="_blank"
                className="w-fit text-sm md:text-lg hover:text-grooveHover underline"
              >
